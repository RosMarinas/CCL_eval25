...
2. `docs/dcr/harness-contract.md`: split direct-final submission evaluation from the true reasoner-to-formatter harness.
3. Contract docs: `docs/contracts/data-schema.md`, `docs/contracts/harness.md`, `docs/contracts/eval-plan.md`, `docs/plans/training-plan.md`.
4. Current code and tests under `src/` and `tests/`.
5. Remote runtime artifacts under `data/` and `checkpoints/`.
...
- Some docs describe from-zero execution, while remote state is already past E3, teacher-data filtering, B8, and BC8 experiments.
...
- `docs/contracts/`: schema, harness, evaluation, prompt, and teacher-data contracts.
...
- `docs/superpowers/plans/`: implementation plans generated by the planning workflow.

## Docs Move Map Applied

| Previous path | Current path | Reason | Status |
| --- | --- | --- | --- |
| `docs/data-schema.md` | `docs/contracts/data-schema.md` | Core schema contract | Applied; references updated |
| `docs/harness.md` | `docs/contracts/harness.md` | True harness contract | Applied; references updated |
| `docs/eval-plan.md` | `docs/contracts/eval-plan.md` | Evaluation contract | Applied; references updated |
| `docs/prompt-baseline.md` | `docs/contracts/prompt-baseline.md` | Prompt contract and baseline protocol | Applied; references updated |
| `docs/teacher-data.md` | `docs/contracts/teacher-data.md` | Teacher-data contract | Applied; references updated |
...
| `docs/dcr-harness-contract.md` | `docs/dcr/harness-contract.md` | Harness design-change record | Applied; references updated |
...
| `docs/superpowers/plans/*` | `docs/superpowers/plans/*` | Planning workflow output | No move |
